...
class FlushTransaction {
 public:
  FlushTransaction(const FlushTransaction&) = delete;
  FlushTransaction& operator=(const FlushTransaction&) = delete;

  explicit FlushTransaction(const std::string& name) : _name(name) {}
