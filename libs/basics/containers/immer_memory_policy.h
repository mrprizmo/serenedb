...
// NOLINTBEGIN
template<typename Heap, size_t Limit = ::immer::default_free_list_size>
struct ThreadLocalFreeListHeapPolicy {
...
using serene_heap_policy = ThreadLocalFreeListHeapPolicy<::immer::cpp_heap>;
using serene_memory_policy =
  ::immer::memory_policy<serene_heap_policy, ::immer::default_refcount_policy,
